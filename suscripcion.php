  ...
  <div class="row">
        <div class="align-items-center mt-4 bienvenida">
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                  <h3 class="display-5 font-weight-bold mb-2 text-center animated infinite pulse delay-2s slower">Area de suscripcion </h3> 
            </div>
        </div>
  </div>
</section>
...
<section class="container">
    <h1 class="py-3 text-center">Elige uno de nuestros planes</h1>
    <section class="container">  
        <aside>
            <p>A) Adquisición de LeX</p>
        </aside>
        <aside>
            <p>Si su empresa está interesada en adquirir el LeX, seleccione la opción de su interés:</p>
        </aside>
    </section>
    <div class="row">
      ...
      <div class="col-md-7 mb-4">
        ...
        <div class="card-body card-body-cascade text-center">
          ...
          <!-- Title -->
          <h4 class="card-title"><strong>Plan estudiantil</strong></h4>
          <!-- Subtitle -->
          <h6 class="font-weight-bold indigo-text py-2">Caracteristicas</h6>
          <!-- Text -->
          ...
          <!-- Button -->
              <a class="btn btn-unique" href="datos-suscripcion">mas detalles..</a>
        </div>
      </div>      
    </div>
    <div class="row">
      <div class="col-md-7 mb-4">
        ...
        <div class="card-body card-body-cascade text-center">
          ...
          <!-- Title -->
          <h4 class="card-title"><strong>Plan empresarial</strong></h4>
          <!-- Subtitle -->
          <h6 class="font-weight-bold indigo-text py-2">Caracteristicas</h6>
          <!-- Text -->
          <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus, ex, recusandae.
        ...
        <div class="col-md-4 mb-4">
            ...
            <div class="card card-cascade">
              ...
              <div class="card-body card-body-cascade text-center">
                ...
                <!-- Title -->
                <h4 class="card-title"><strong>Plan corporativo</strong></h4>
                <!-- Subtitle -->
                <h6 class="font-weight-bold indigo-text py-2">Caracteristicas</h6>
                <!-- Text -->
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus, ex, recusandae.
...
<!--<section class="container">  
    <aside>
        <p>B) Opciones de pago</p>
    </aside>
    <aside>
        <ol class="ml-md-3 ml-sm-1">
          <li>Abono en dólares a la cuenta Nº 1042-268806; o abono en bolivianos a la cuenta Nº 1041-268794, del Banco Económico S.A.
Nota.- Una vez realizado el depósito, por favor enviar el comprobante al Fax: (2) 2112752 o legislacion.express@bo.pwc.com, indicando a la empresa a la que pertenece el pago, con la finalidad de identificar el pago realizado.</li>
          <li>Pago con cheque a nombre de PricewaterhouseCoopers S.R.L.</li>
          <li>En efectivo en las oficinas de PricewaterhouseCoopers, Pasaje Villegas Nº 383, Edif Ana Marìa p. 1, 2 y 3.</li>
        </ol>
    </aside>
</section>
<section class="container">  
    <aside>
        <p>C) Datos de la empresa.</p>
    </aside>
    <aside>
        <p>Por favor complete los datos solicitados a continuación:</p>
        <!--Section: Contact v.2
        <section class="mb-4">
            <div class="row">
                <!--Grid column--
                    ...
                    <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="md-form mb-0">
                                    ...
                                    <label for="email" class="">NIT:</label>
                                </div>
                            </div>
                            <!--Grid column--
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="md-form mb-0">
                                    <input type="text" id="email" name="email" class="form-control">
                                    <label for="email" class="">Ciudad:</label>
                                </div>
                            </div>
                            <!--Grid column--
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="md-form mb-0">
                                    <input type="text" id="name" name="name" class="form-control">
                                    <label for="name" class="">Persona de contacto:</label>
                                </div>
                            </div>
                            <!--Grid column--
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="md-form mb-0">
                                    <input type="text" id="email" name="email" class="form-control">
                                    <label for="email" class="">  Fax:</label>
                                </div>
                            </div>
                            <!--Grid column--
                        ...
                        <div class="text-center text-md-left">
                            <a class="btn btn-primary" onclick="document.getElementById('contact-form').submit();">Inscribisrse</a>
                        </div>
                    </form>
