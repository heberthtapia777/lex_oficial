...
<!-- Navbar burger on large screens right -->
                ...
                <div class="col-md-4 my-5">
                    ...
                    <div class="card booking-card">
                      ...
                      <div class="card-body">
                        ...
                        <!-- Title -->
                        <h4 class="card-title font-weight-bold text-center"><a>Titulo tax alert</a></h4>
                        <!-- Data -->
                        <!-- Text -->
        ...
        <section class="anuncios mx-3">
            <div class="row">
                ...
                <div class="col-md-5">
                    <h2 class="text-center my-5">Titulo del taxt alert</h2>
                    <p class="text-center my-2"> Lorem ipsum dolor upiditate alias nesciunt eaque, numquam in est porro? Enim eos praesentium 
                        perferendis itaque non, necessitat. Lorem ipsum dolor upiditate alias nesciunt eaque, numquam in est porro? Enim eos praesentium 
                        perferendis itaque non, necessitat.
                    </p>
                    <!-- Button -->
