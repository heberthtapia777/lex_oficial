    ...
    <body>
            ...
            <div class="row">
                <div class="align-items-center mt-4 bienvenida">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <h3 class="display-5 font-weight-bold mb-2 text-center animated infinite pulse delay-2s slower">
        ...
        <section class="anuncios mx-3">
                <div class="row">
                    <div class="col-md-6 mt-4 mb-4">
                        ...
                        <div class="card">
                          ...
                          <div class="view overlay">
                            <img class="card-img-top" src="../images/4.jpg" alt="comunicado">
                          </div>
                          ...
                          <div class="card-body">
                            ...
                            <!-- Title -->
                            <h4 class="card-title text-center">Titulo del comunicado</h4>
                            <hr>
                            <!-- Text -->
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusantium, atque nemo corporis voluptatibus? Nihil, consequuntur dolorum totam eaque neque repellendus! Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur assumenda neque, iusto omnis temporibus ipsam, similique enim consequatur labore doloribus.</p>
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-dark btn-sm">Mas detalles...</button>
                            </div>
                          </div>
                          ...
                          <div class="rounded-bottom mdb-color lighten-3 text-center pt-3">
                            <ul class="list-unstyled list-inline font-small">
                              <li class="list-inline-item pr-2 dark-text"><i class="far fa-clock pr-1"></i>05/10/2015</li>
                              <li class="list-inline-item pr-2"><a href="#" class="dark-text"><i
                                    class="far fa-user pr-1"></i>Admin</a></li>
                            </ul>
                          </div>
                    ...
                    <div class="col-md-6 mt-4 mb-4"><!-- Card -->
                        <div class="card">

                          <!-- Card image -->
                          <div class="view overlay">
                            <img class="card-img-top" src="../images/6.jpg" alt="comunicado">
                          </div>
                          ...
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- Text -->
                            <p class="card-text">Lorem ipsum dolor, sit, amet consectetur adipisicing elit. Laboriosam, deserunt? Quasi dolorem illo error, explicabo esse assumenda culpa sapiente possimus. Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Repudiandae odit, rem dicta exercitationem, est esse quis nulla adipisci soluta architecto.</p>
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-dark btn-sm">Mas detalles...</button>
                            </div>
                          </div>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body mx-3">
                      <div class="md-form mb-5">
                          <i class="far fa-user prefix grey-text">
                          </i>
                      ...
                      <div class="md-form mb-4">
                          <i class="far fa-lock prefix grey-text">
                          </i>
