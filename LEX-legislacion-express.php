...
<head>
  ...
  <title>LEX - legislacion express</title>
</head>
<style>
  .bg-light{
  ...
  <div class="row">
        <div class="align-items-center mt-4 bienvenida">
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                  <h3 class="display-5 font-weight-bold mb-2 text-center animated infinite pulse delay-2s slower">LEX - legislacion express</h3> 
            </div>
        </div>
  </div>
</section>
...
<div class="jumbotron suscripcion card card-image text-center">
  ...
  <!-- Grid row -->
  <div class="pt-2">
    <a href="suscripcion" type="button" class="btn btn-blue waves-effect">Suscribete <span class="fas  fa-gem ml-1"></span></a>
  </div>
</div>
<!-- Jumbotron -->
<!-- Footer -->
