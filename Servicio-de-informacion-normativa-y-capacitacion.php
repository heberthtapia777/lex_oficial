...
<head>
  ...
  <title>Servicio de informacion normativa y capacitacion</title>
</head>
<style>
  .bg-light{
  ...
  <div class="row">
        <div class="align-items-center mt-4 bienvenida">
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                  <h3 class="display-5 font-weight-bold mb-2 text-center animated infinite pulse delay-2s slower">Servicio de informacion normativa y capacitacion </h3> 
            </div>
        </div>
  </div>
</section>
