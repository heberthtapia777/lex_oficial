		  	...
		  	<div class="card mb-3">
				<div class="card-body">
					<div class="row flex-between-center">
						<div class="col-md">
							<h5 class="mb-2 mb-md-0">GESTOR DE CONTENIDOS</h5>
						</div>
						<div class="col-auto">
					...
					<div class="col-lg-12">
						<div class="card mb-3">
							<div class="card-body bg-light">
								<div class="row gx-2">
									<div class="col-lg-5"><img class="img-fluid rounded" src="../../assets/img/logos/pwc-logo.png" alt="" /></div>
									<div class="col-lg-7 pl-lg-4 my-5 text-center text-lg-left">
										<h3>Bienvenido al GESTOR DE CONTENIDOS de PWC</h3>
										<p class="lead">Puedes gestionar varios modulos desde el menu lateral de la izquierda.</p>
										<p class="lead">Todos los cambios realizados desde el gestor de contenidos se muestran automaticamente en la pagina web.</p>
									</div>
								</div>
							</div>
						</div>
