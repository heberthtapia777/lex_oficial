...
<head>
	...
	<body>
			...
			<div class="card mb-3">
				<div class="card-body">
					<div class="row flex-between-center">
						<div class="col-md">
							<h5 class="mb-2 mb-md-0">Gestor Banner</h5>
						</div>
						<div class="col-auto">
					...
					<div class="col-lg-12">
						<div class="card mb-3">
							<div class="card-body bg-light">
								<div class="row gx-2">
									<table id="tblBanner" class="table table-striped table-bordered table-condensed table-hover" cellspacing="0" cellpadding="0" width="100%">
										<thead>
											<tr>
												<th>#</th>
												<th>Imagen</th>
			...
			<div id="verForm">
				<div class="card mb-3">
					<div class="card-body">
						<div class="row flex-between-center">
							<div class="col-md">
								<h5 class="mb-2 mb-md-0">Nuevo Banner</h5>
							</div>

						</div>
					</div>
				</div>
				<form role="form" name="frmBanner" id="frmBanner" enctype="multipart/form-data" class="cmxform">
				<div class="row g-0">
							...
							<div class="card-body bg-light">
								<div class="row gx-2">
									<div class="col-12 mb-3">
										<input id="banner_id" type="hidden" name="banner_id" />
										<label class="form-label" for="banner_title">Titulo</label>
										<input class="form-control" id="banner_title" name="banner_title" type="text" placeholder="Titulo" />
									</div>
									<div class="col-12 mb-3">
										<label class="form-label" for="banner_subtitle">Sub-Titulo</label>
										<input class="form-control" id="banner_subtitle" name="banner_subtitle" type="text" placeholder="Titulo" />
									</div>
								</div>
					...
					<div class="col-lg-4 pl-lg-2">
						<div class="card mb-3 mb-lg-0">
							...
							<div class="card-body bg-light">
								<div class="form-file">
									<input class="form-file-input" id="banner_img" name="banner_img" type="file" value="" />
									<label class="form-file-label" for="banner_img">
		...
		<script src="../../assets/js/scripts/banner.js"></script>
