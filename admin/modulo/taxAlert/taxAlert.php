	...
	<body>
		...
		<div class="container" data-layout="container">
			...
			<div class="card mb-3">
				<div class="card-body">
					<div class="row flex-between-center">
						<div class="col-md">
							<h5 class="mb-2 mb-md-0">Tax Alert</h5>
						</div>
						<div class="col-auto">							
					...
					<div class="col-lg-12">
						<div class="card mb-3">                
							<div class="card-body bg-light">							
								<div class="row gx-2">
									<table id="tblTaxAlert" class="table table-striped table-bordered table-condensed table-hover" cellspacing="0" cellpadding="0" width="100%">
										<thead>
											<tr>
												<th>#</th>
												<th>Titulo</th>
			...
			<div id="verForm">
				...
				<form role="form" name="frmTaxAlert" id="frmTaxAlert" enctype="multipart/form-data" class="cmxform">
				<div class="row g-0">				
							...
							<div class="card-body bg-light">							
								<div class="row gx-2">
									<div class="col-12 mb-3">
										<input id="tax_id" type="hidden" name="tax_id" />
										<label class="form-label" for="tax_title">Titulo</label>
										<input class="form-control" id="tax_title" name="tax_title" type="text" placeholder="Titulo" />
									</div>                      
									<div class="col-12">
										<label class="form-label" for="tax_resume">Resumen</label>
										<textarea class="form-control" id="tax_resume" name="tax_resume" rows="6"></textarea>
									</div>
									<div class="col-12">
										<label class="form-label" for="tax_contens">Contenido</label>
										<textarea class="form-control" id="tax_contens" name="tax_contens" rows="6"></textarea>
									</div>
								</div>
					...
					<div class="col-lg-4 pl-lg-2">					
						<div class="card mb-3 mb-lg-0">
							...
							<div class="card-body bg-light">
								<div class="form-file">
									<input class="form-file-input" id="tax_img" name="tax_img" type="file" />
									<label class="form-file-label" for="tax_img">
								...
								<br>
								<div class="form-file">
									<input class="form-file-input" id="tax_file" name="tax_file" type="file" />
									<label class="form-file-label" for="tax_file">
		...
		<script src="../../assets/js/scripts/taxAlert.js"></script>
