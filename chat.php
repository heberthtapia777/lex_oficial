<?php 
    ...
    require_once 'admin/PHPThumb/ThumbLib.inc.php';
...
<link href="admin/modulo/chat/css/fontawesome/css/all.css" rel="stylesheet"> <!--load all styles -->
<link href="admin/modulo/chat/css/jquery.mCustomScrollbar.css" rel="stylesheet" type="text/css">
<link href="admin/modulo/chat/css/chatboxw.css" rel="stylesheet">
</head>
<body>
...
<aside id="iconChat" class="animation-target">
	<a href="#" onclick="openChat();">
		<div>
			<img src="admin/modulo/chat/img/chat3.png" width="45">
		</div>
	</a>
</aside>
            ...
            <div>
                <div class="popup-head-left float-left">
                    ...
                    <?php
                        try
                        {
                            $thumb = PhpThumbFactory::create("admin/modulo/chat/img/abatar.jpeg");
                        }
                        catch (Exception $e)
                        {
                        ...
                        //$thumb->show();
                        $thumb->save("admin/modulo/chat/img/thumbnail/abatar.jpeg");                
                    ?>
                        <img class="thumb md-user-image" src="admin/modulo/chat/img/thumbnail/abatar.jpeg" alt="">
