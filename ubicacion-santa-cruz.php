...
<head>
  ...
  <title>Nuestra ubicacion en Santa Cruz</title>
</head>
<style>
  .bg-light{
  ...
  <div class="row">
        <div class="align-items-center mt-4 bienvenida">
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                  <h3 class="display-5 font-weight-bold mb-2 text-center animated infinite pulse delay-2s slower">Nuestra ubicacion en Santa Cruz </h3> 
            </div>
        </div>
  </div>
</section>
...
<section class="section my-5 mx-5">
  <!--Section heading-->
  <h2 class="section-heading h1 pb-4 text-center">Contactanos</h2>
  <div class="row">
    <!--Grid column-->
      ...
      <div class="card">
        <div class="card-body  my-5">
          <ul class="list-unstyled mb-0">
              <h4 class="text-center mb-2">Nuestra direccion</h4>
            <li><i class="fas fa-map-marker-alt fa-2x"></i>
                <p>Edificio Ana Maria, N° 383, Villegas, La Paz</p>
            </li>
            <li><i class="fas fa-phone mt-4 fa-2x"></i>
                <p>+59122408181</p>
            </li>
            <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                <p>contact@pwc.com.bo</p>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="col-md-9 my-1">
      ...
      <div id="map-container-google-11" class="z-depth-1-half map-container-6" style="height: 400px">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15198.948009162428!2d-63.1971306!3d-17.757027!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe46efc4c0e94ada0!2sPwC%20Santa%20Cruz!5e0!3m2!1ses!2sbo!4v1643656953048!5m2!1ses!2sbo" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
      </div>
    </div>
    <!--Grid column-->
  </div>
